...
def import_models_data():
    ...
    return np.load('./source_data/models.npy', allow_pickle=True).flat[0]
...
def import_movement():
    ...
    return np.load('./source_data/movement.npy')
...
def import_target_pos():
    ...
    return np.load('./source_data/target_pos.npy')
...
def import_target_angle():
    ...
    return np.load('./source_data/target_angle.npy')
...
def import_condition():
    ...
    return np.load('./source_data/condition.npy')
...
def import_decoding_r2():
    ...
    return np.load('source_data/decoding_r2.npy', allow_pickle=True).flat[0]
